...
function make_scene_objects(scene_group, data_files, data_cstor, extra_shape_data) {

    for (let i = 0; i < data_files.length; i++) {
        parse_simulation_data(scene_group, data_files[i], data_cstor, extra_shape_data);
    }
}
...
async function parse_simulation_data(scene_group, object_json_file, data_cstor, extra_shape_data) {
